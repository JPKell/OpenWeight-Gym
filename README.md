...
| Status | Row W1 (2026-09-09): `0.1.0` on PyPI (`pip install wr-gym`; GitHub release `v0.1.1`, see CHANGELOG) — `wr-gym setup && wr-gym serve` gives an HTTPS console with a login and the audit trail; process control, the shell and the application pages are rows W2–W9 (`docs/roadmap/weightroom-work.md`). |
