...
**Runs after:** **I3** (done 2026-09-06, `docs/history/I3_HANDOFF.md`).
...
1. `docs/history/I3_HANDOFF.md` §9 (*What J1 inherits* — the snapshot finding) and §10 item 5.
2. `docs/history/I2_HANDOFF.md` §5 (the digest bullet), §10 (run 3, F2), §13, §14.
...
Write `docs/history/I4_HANDOFF.md` in the shape of `I3_HANDOFF.md`: gate results with exact
