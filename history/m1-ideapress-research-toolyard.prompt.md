...
* **Research notes flow into `assemble_context`** — which deliberately reopens J2's dead
  `research_notes` path (`docs/history/J2_HANDOFF.md` ~line 188 and row K3's comment in
...
6. `docs/history/E4_HANDOFF.md` (PromptCadence Phase 4, the first consumer — what ToolYard's API
   turned out to cost), `docs/history/D1_HANDOFF.md` (the sandbox's real behaviour: prlimit inside
...
8. `docs/history/J1_HANDOFF.md`, `J2_HANDOFF.md`, `K3_HANDOFF.md` — how the stage runner, the
...
Write `docs/history/M1_HANDOFF.md` (row M1 of outstanding-work, not milestone M1), house shape:
