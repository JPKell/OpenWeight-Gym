...
4. [`history/I2_HANDOFF.md`](I2_HANDOFF.md) §5 (why the endpoints are unbuilt) and
   [`history/I4_HANDOFF.md`](I4_HANDOFF.md) §6 (what I5 inherits: nothing but the version edge).
...
Write `docs/history/I5_HANDOFF.md`, in the house shape:
