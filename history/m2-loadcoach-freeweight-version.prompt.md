...
3. `docs/history/L8_HANDOFF.md` — the finding, and the degradation cell it left `untested`.
...
Write `docs/history/M2_HANDOFF.md` (row M2 of outstanding-work, not milestone M2): gates as
