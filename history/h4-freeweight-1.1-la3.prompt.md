...
* **LoadCoach's `setspec` pin move — done at H2**, not here (`docs/history/H2_HANDOFF.md` §4).
...
2. `docs/history/H2_HANDOFF.md` §4 (what H4 loses and keeps) and §8 (**the `bind_identity` rule 0
...
9. `docs/history/E5_HANDOFF.md` and `docs/history/F2_HANDOFF.md` §7 — the pin-and-lock lessons, all
   five of them, before you touch a lock file.
10. `docs/history/H1_HANDOFF.2.md` §3–§5 — the artefacts, and the CUDA-graphs default your runs
    will inherit.
...
* Note the shape H1 settled: **`register_adapters()` takes the complete set** and a name absent
  from it is retired at the next idle (`docs/history/H1_HANDOFF.2.md` §6). A rescan restates the
  directory whole.
