...
|---|---|---|---|
| [`weightroom-work.md`](weightroom-work.md) | **WeightRoomGym** — the fifth application, the host operator's console (rows W0–W10, WS1–WS4, WM, WM2) | 2026-09-09 | W0–W9, WS1–WS4, WM, WA1, WI1 done; W10 built 2026-09-10 (`1.0.0` prepared), its Gate D verification the operator's; WM2 done 2026-09-10 (versions held); nothing scheduled after |
