...
* Python: 3.12+
* Specification: [`docs/packages/toolyard/spec.md`](../spec.md) ·
  plan: [`docs/packages/toolyard/development-plan.md`](../development-plan.md)
...
[`docs/quickstart.md`](quickstart.md) for a ten-line runnable example.
...
`SECURITY.md`. Tool arguments are attacker-controlled and tool results are
