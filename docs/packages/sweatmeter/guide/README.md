...
| Read this | For |
|---|---|
| [docs/packages/sweatmeter/spec.md](../spec.md) | Purpose, scope, non-goals, public contracts, configuration, acceptance criteria |
| [docs/packages/sweatmeter/development-plan.md](../development-plan.md) | The phased build plan: goals, work, tests, acceptance criteria per phase |
| [docs/quickstart.md](quickstart.md) | Snapshot, profile, sampler, deterministic-test, and derived-metric examples |
