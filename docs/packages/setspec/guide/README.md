...
The [schema catalogue](../schemas.md) lists every payload type, its artifacts, and the
...
See the [development plan](../development-plan.md) for what each phase adds.
...
See [docs/packages/setspec/spec.md](../spec.md) §7 for the full public API and
...
| Read this | For |
|---|---|
| [docs/packages/setspec/spec.md](../spec.md) | Purpose, scope, non-goals, public contracts, configuration, acceptance criteria |
| [docs/packages/setspec/development-plan.md](../development-plan.md) | The phased build plan: goals, work, tests, acceptance criteria per phase |
