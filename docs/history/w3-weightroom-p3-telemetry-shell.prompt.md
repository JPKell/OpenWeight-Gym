...
`packages/modelrack/spec.md` (`list_resident`); `history/W2_HANDOFF.md`, `history/WM_HANDOFF.md`.
...
Gate green, coverage held, one commit per gate, `docs/history/W3_HANDOFF.md`, the row marked done.
