...
`history/W4_HANDOFF.md` (the connection strings come from the schema documents).
...
`docs/history/W7_HANDOFF.md`, the row marked done. Never overnight; reviewed the same day.
