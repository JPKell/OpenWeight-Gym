...
* **The artefacts exist.** Three LoRA GGUFs for `Qwen2.5-1.5B-Instruct.Q8_0` under
  ...
  `~/ai/models/llm/Qwen2.5-1.5B-Instruct.Q8_0.gguf`. Digests in `docs/history/handoffs/H1_HANDOFF.2.md` §4.
...
defect** (`docs/history/handoffs/F3_HANDOFF.md` finding 4) — the code imports, then fails at the first
...
1. `docs/history/handoffs/H2_HANDOFF.2.md` §§4–5 (the decisions and the two unplanned builds), §7 (**what H3
...
10. `docs/history/handoffs/H1_HANDOFF.2.md` §§3–4 — the artefacts, and the I16 assertion shape.
