...
1. **Write `docs/history/handoffs/C1_HANDOFF.md` at the workspace root.** Sections: gate results with interpreter and
   ...
   **the three settled shapes from §1 above** (report fields, `budget_unmet`, metadata) as decisions
   ...
   `docs/history/handoffs/C1_HANDOFF.md` exists, write `C1_HANDOFF.2.md` and say why.
...
* If you must stop early, stop at a green gate with a commit, tree clean, and record exactly where
  you stopped in `docs/history/handoffs/C1_HANDOFF.md`.
