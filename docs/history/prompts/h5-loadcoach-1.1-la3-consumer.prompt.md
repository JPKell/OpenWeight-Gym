...
3. `docs/history/handoffs/H4_HANDOFF.md` §3 (I18's evidence, both halves, verbatim) and §12 (the two
...
10. `docs/standards/testing-standards.md` §10.1 and `docs/history/handoffs/H2_HANDOFF.md` §7 — the dialect
