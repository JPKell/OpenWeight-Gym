...
6. `docs/history/handoffs/E3_HANDOFF.md` — Commissioner Phase 2 as built, and anything it flagged for its first consumer.
7. `docs/history/handoffs/F1_HANDOFF.md` — the ledger mount and migration shape you are about to copy for
...
* **Copy F1's mount + migration shape exactly.** F1 established it as the first-instance example
  ...
  again, re-read `docs/history/handoffs/F1_HANDOFF.md`.
...
2. **`docs/history/handoffs/F2_HANDOFF.md` at the workspace root**, house shape: gate results; the resolved
