...
* **C4 wrote you a brief.** `docs/history/handoffs/C4_HANDOFF.md` **§10 "To D2"** lists what is settled and must not be
...
7. **`docs/history/handoffs/C4_HANDOFF.md` §10.**
...
be built against your fake. `docs/history/handoffs/C6_HANDOFF.md` **§6** carries the before/after JSON and the reasoning.

## Before you finish — closing duties

1. **Write `docs/history/handoffs/D2_HANDOFF.md` at the workspace root.** Sections: gate results with the interpreter and
   ...
   **Never overwrite an existing root file** — the workspace root is not a git repository. If
   `docs/history/handoffs/D2_HANDOFF.md` exists, write `docs/history/handoffs/D2_HANDOFF.2.md` and say why.
...
* If you must stop early, stop at a green gate with a commit and a clean tree, and record exactly
  where you stopped in `docs/history/handoffs/D2_HANDOFF.md`.
