...
**Runs after:** D3 (Phase 6, `docs/history/handoffs/D3_HANDOFF.md`) and F3 (Phase 7, `docs/history/handoffs/F3_HANDOFF.md`).
...
timings. I17's semantic canary needs the same artefacts. `docs/history/handoffs/F3_HANDOFF.md` §6 states
...
is not reopened here (`docs/history/handoffs/F3_HANDOFF.md` §9.3). It is built, in two pieces:
...
from the request side.** `docs/history/handoffs/G2_HANDOFF.md` §4–§5 has the measurement: `tools.plan` on
...
1. `docs/history/handoffs/F3_HANDOFF.md` **§6** (what the canary needs), **§7** (eight things the last
...
6. `docs/history/handoffs/D3_HANDOFF.md` **finding 6** (sharded GGUFs, skipped at discovery with a debug log)
   and `docs/history/handoffs/G2_HANDOFF.md` **§4–§5** (the thinking-control measurement).
...
* **Do not reopen F3's settled decisions** (`docs/history/handoffs/F3_HANDOFF.md` §9.2): the complete-`lora`
