...
`history/handoffs/W3_HANDOFF.md`. Precedent: LoadCoach's provider-admin write path (ADR-0117's
...
Gate green, coverage held, one commit per gate, `docs/history/handoffs/W4_HANDOFF.md`, the row marked done.
