...
1. **Write `docs/history/handoffs/B4_HANDOFF.md` at the workspace root.** Sections: gate results with interpreter and
   ...
   **Never overwrite an existing root file** — the workspace root is not a git repository and has
   no history to recover from. If `docs/history/handoffs/B4_HANDOFF.md` exists, write `B4_HANDOFF.2.md` and say why.
...
* If you must stop early, stop at a green gate with a commit, tree clean, and record exactly where
  you stopped in `docs/history/handoffs/B4_HANDOFF.md`.
