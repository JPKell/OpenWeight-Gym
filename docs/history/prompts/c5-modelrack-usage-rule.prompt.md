...
8. **`docs/history/handoffs/B2_HANDOFF.md` §5 item 7** — where this defect was found, with the measured numbers (input
...
1. **Write `docs/history/handoffs/C5_HANDOFF.md` at the workspace root.** Sections: gate results with interpreter and
   ...
   **Never overwrite an existing root file** — the workspace root is not a git repository. If
   `docs/history/handoffs/C5_HANDOFF.md` exists, write `C5_HANDOFF.2.md` and say why.
...
* If you must stop early, stop at a green gate with a commit, tree clean, and record exactly where
  you stopped in `docs/history/handoffs/C5_HANDOFF.md`.
