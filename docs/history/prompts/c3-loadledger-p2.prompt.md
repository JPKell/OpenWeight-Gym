...
* **Lockfiles:** adding `sqlalchemy`, `alembic` and a PostgreSQL driver to `[dev]` means
  ...
  `docs/history/handoffs/C1_HANDOFF.md` §7 first — it records a pip-tools trap (`--no-index` written into the header)
...
7. **`docs/history/handoffs/B2_HANDOFF.md` §§2.1–2.3 and §5** — the surface as built, the five departures (four of which
...
1. **Write `docs/history/handoffs/C3_HANDOFF.md` at the workspace root.** Sections: gate results with interpreter and
   ...
   a git repository. If `docs/history/handoffs/C3_HANDOFF.md` exists, write `C3_HANDOFF.2.md` and say why.
...
* If you must stop early, stop at a green gate with a commit, tree clean, and record exactly where
  you stopped in `docs/history/handoffs/C3_HANDOFF.md`.
