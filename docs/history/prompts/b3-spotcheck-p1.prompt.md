...
Read `docs/history/handoffs/B1_HANDOFF.md` at the workspace root before starting — it carries the field lists as actually
...
6. `docs/history/handoffs/B1_HANDOFF.md` (workspace root) and `py/SetSpec`'s published `governance.egress_decision`
...
1. **Write `docs/history/handoffs/B3_HANDOFF.md` at the workspace root.** Sections: gate results with interpreter and
   ...
   **Never overwrite an existing root file.** If `docs/history/handoffs/B3_HANDOFF.md` exists, write `B3_HANDOFF.2.md`
   and say why.
...
* If you must stop early, stop at a green gate with a commit, tree clean, and say where in
  `docs/history/handoffs/B3_HANDOFF.md`.
