...
* **Four repositories are unpushed, and E4's pushes are owed before yours**
  (`docs/history/handoffs/E4_HANDOFF.md` §8): `docs` ahead 4 (`943fbe1`), `LoadCoach` ahead 1 (`5c5aa1f`),
...
1. **PromptCadence has no `requirements/` directory at all.** Its `ci.yml` installs `-e ".[dev]"`
   ...
   already recorded as their own future row — `docs/history/handoffs/D2_HANDOFF.2.md` §7, `docs/history/handoffs/E4_HANDOFF.md` §9. **Do not
   build them here.**)
...
6. `docs/history/handoffs/E4_HANDOFF.md` §8 (the owed pushes) and §9 (the open items you must not chase).
...
2. **`docs/history/handoffs/E5_HANDOFF.md` at the workspace root**, house shape: gate results; the resolved-version table
