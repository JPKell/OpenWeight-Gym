...
did, and read `docs/history/handoffs/C1_HANDOFF.md` §7 first — it records a pip-tools trap (`--no-index` written into the
...
9. `py/CutCtx` — the repository-shape precedent and the freshest example of this arc's discipline;
   `docs/history/handoffs/C1_HANDOFF.md` §§5–7 for how a "there is only one path" guard was made structural and proven to
...
1. **Write `docs/history/handoffs/C2_HANDOFF.md` at the workspace root.** Sections: gate results with interpreter and
   ...
   **the four settled shapes from §2** (allowlist scope, egress input, sandbox seam, caps/timeouts)
   ...
   workspace root is not a git repository. If `docs/history/handoffs/C2_HANDOFF.md` exists, write `C2_HANDOFF.2.md` and
   say why.
...
* If you must stop early, stop at a green gate with a commit, tree clean, and record exactly where
  you stopped in `docs/history/handoffs/C2_HANDOFF.md`.
