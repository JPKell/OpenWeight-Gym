...
10. **`docs/history/handoffs/B4_HANDOFF.md` §7** — four notes written for this session, including the `config.Tier`
...
1. **Write `docs/history/handoffs/C4_HANDOFF.md` at the workspace root.** Sections: gate results with interpreter and
   ...
   not a git repository. If `docs/history/handoffs/C4_HANDOFF.md` exists, write `C4_HANDOFF.2.md` and say why.
...
* If you must stop early, stop at a green gate with a commit, tree clean, and record exactly where
  you stopped in `docs/history/handoffs/C4_HANDOFF.md`.
