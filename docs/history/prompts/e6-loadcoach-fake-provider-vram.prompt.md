...
2. `docs/history/handoffs/E4_HANDOFF.md` §5 — the diagnosis, the numbers, and what an operator saw.
...
2. **`docs/history/handoffs/E6_HANDOFF.md` at the workspace root**, house shape: the reproduction and its numbers; the
