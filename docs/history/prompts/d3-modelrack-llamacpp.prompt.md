...
* **C5 built the seam you bind to, and wrote you the brief.** `docs/history/handoffs/C5_HANDOFF.md` **§5 — "the
...
change here is live in their suites immediately (recorded in `docs/history/handoffs/C5_HANDOFF.md` §7).
...
6. **`docs/history/handoffs/C5_HANDOFF.md` §§2, 5 and 6** — the usage rule as implemented per adapter, **the seam**, and
...
1. **Write `docs/history/handoffs/D3_HANDOFF.md` at the workspace root.** Sections: gate results with the interpreter and
   ...
   **Never overwrite an existing root file** — the workspace root is not a git repository. If
   `docs/history/handoffs/D3_HANDOFF.md` exists, write `D3_HANDOFF.2.md` and say why.
...
* If you must stop early, stop at a green gate with a commit and a clean tree, and record exactly
  where you stopped in `docs/history/handoffs/D3_HANDOFF.md`.
