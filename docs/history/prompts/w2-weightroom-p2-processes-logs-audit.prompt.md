...
`standards/cross-platform-standards.md` §3; `history/handoffs/W1_HANDOFF.md`. Precedents: ToolYard's
...
Gate green, coverage held, one commit per gate, `docs/history/handoffs/W2_HANDOFF.md`, the row marked done.
