...
* [`docs/history/prompts/c5-modelrack-usage-rule.prompt.md`](c5-modelrack-usage-rule.prompt.md)
* [`docs/history/prompts/c6-loadcoach-token-classes.prompt.md`](c6-loadcoach-token-classes.prompt.md)
...
* **Record the captured numbers verbatim in `docs/history/handoffs/C5_HANDOFF.md`** — both `prompt_eval_count` values,
...
* **CI does not have any of this. `requirements/ci.lock` pins `modelrack==0.5.0`,** and CI installs
  ...
  **do not commit it as a test**, and report what you saw in `docs/history/handoffs/C6_HANDOFF.md` as evidence for F1.
...
**stop there.** Write `docs/history/handoffs/C5_HANDOFF.md`, state exactly where you stopped, and **do not start C6.**
...
1. **`docs/history/handoffs/C5_HANDOFF.md`** and **`docs/history/handoffs/C6_HANDOFF.md`**, each with the sections its own prompt lists. Add to
...
2. `docs/history/handoffs/C5_HANDOFF.md` additionally carries the Ollama capture: the numbers, or why you took the
   conservative path.
3. `docs/history/handoffs/C6_HANDOFF.md` additionally carries the editable-venv finding, the `.pth` snapshot before and
