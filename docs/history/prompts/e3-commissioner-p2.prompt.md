...
`docs/history/handoffs/C3_HANDOFF.md` is explicit that a silently skipped dialect is an untested dialect. **Docker 29.7.2
...
**`docs/history/handoffs/C3_HANDOFF.md` §11 was written for this row, by the session that built the thing you are
...
Then read **`docs/history/handoffs/C3_HANDOFF.md` §2** — the five settled shapes, whose heading says outright
...
1. **`docs/history/handoffs/C3_HANDOFF.md` §11 and §2** — above. The design document for this row.
...
6. **`docs/history/handoffs/B3_HANDOFF.md` §3** (the public surface as built) and **§9** (the SpotCheck → Commissioner
...
Copy the shape; do not redesign it. `docs/history/handoffs/C3_HANDOFF.md` §11's "copy, unchanged in shape" list is the
...
1. **`docs/history/handoffs/E3_HANDOFF.md`** at the workspace root. **Never overwrite an existing root file** — the
   ...
   steps."**
2. **`docs/history/handoffs/E3_HANDOFF.md` additionally carries** a note for **J1**: ADR-0050's revisit clause makes the
...
* **Do not relitigate what `docs/history/handoffs/C3_HANDOFF.md` §2 and §11 settled**, or what `docs/history/handoffs/B3_HANDOFF.md` §3 built.
