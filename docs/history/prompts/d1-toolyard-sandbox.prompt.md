...
* **The spec was amended on 2026-09-03, and this row implements into the amended text.** C2 built
  ...
  **Read the current [`spec.md`](docs/packages/toolyard/spec.md), not `docs/history/handoffs/C2_HANDOFF.md`'s proposal
...
5. **`docs/history/handoffs/C2_HANDOFF.md` §4(c)** — *"the sandbox seam: what D1 must implement, and what it must not
...
1. **Write `docs/history/handoffs/D1_HANDOFF.md` at the workspace root.** Sections: gate results with the interpreter and
   ...
   **Never overwrite an existing root file** — the workspace root is not a git repository. If
   `docs/history/handoffs/D1_HANDOFF.md` exists, write `D1_HANDOFF.2.md` and say why.
...
* If you must stop early, stop at a green gate with a commit and a clean tree, and record exactly
  where you stopped in `docs/history/handoffs/D1_HANDOFF.md`.
