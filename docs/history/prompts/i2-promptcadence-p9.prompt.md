...
* No `docs/history/handoffs/I1_HANDOFF.md`, and row I1 in `outstanding-work` §1 carries no **Done** note.
...
partly unproved is the failure mode H2 stopped for (`docs/history/handoffs/H2_HANDOFF.md` §0.5) and the one
M7 caught (`docs/history/handoffs/M7_HANDOFF.md`).

## 0.2 The remote-tier fork — I13, or the recorded release-scope decision

**H2 delivered the half this row needs.** `docs/history/handoffs/H2_HANDOFF.md` §272: LC-E1 is built —
...
2. **The cap on replayed tool-call arguments** — G2's moved hazard,
   `docs/history/handoffs/G2_HANDOFF.md` §10, left to this row on purpose. `tool_calls[].arguments` is
...
5. **G3 left one ordering question that is a spec question, not a test question**
   (`docs/history/handoffs/G3_HANDOFF.md` §9b): a `turn_overrun` deviation and `STEP_LIMIT_EXCEEDED` can both
...
4. Handoffs, in this order: **`docs/history/handoffs/G1_HANDOFF.md` §8** (the vectors) and **§13** (what must
   not be relitigated); **`docs/history/handoffs/G2_HANDOFF.md` §9 and §10**; **`docs/history/handoffs/G3_HANDOFF.md`
   §7 and §9**; **`docs/history/handoffs/H2_HANDOFF.md` §272** and **`H2_HANDOFF.2.md` §7**; and I1's handoff,
...
and the row was better for it (`docs/history/handoffs/M7_HANDOFF.md`). Run it last, run it whole, and report
...
* **Do not cut 1.0 with an unproved exit condition** (`docs/history/handoffs/H2_HANDOFF.md` §0.5). If §0.1's
