...
6. `docs/history/handoffs/D3_HANDOFF.md`, **§13 especially** — what P6 actually built, the digest-store decision, the
...
(`**Done 2026-09-0X** (`docs/history/handoffs/F3_HANDOFF.md`; commits …)`), record §0.1 (the missing plan section, now
...
2. **`docs/history/handoffs/F3_HANDOFF.md` at the workspace root**, house shape: gate results; the §0.2 boundary decision
