...
5. `docs/history/handoffs/B2_HANDOFF.md` and `docs/history/handoffs/C3_HANDOFF.md` — LoadLedger Phases 1 and 2 as built, including the
...
7. `docs/history/handoffs/E4_HANDOFF.md` — what P4 left, and the shape of the live journey you will extend.
...
2. **`docs/history/handoffs/F1_HANDOFF.md` at the workspace root**, house shape: gate results; the LoadLedger surface you
