...
**Runs after:** **I2** (done 2026-09-06, `docs/history/handoffs/I2_HANDOFF.md`).
...
* **LoadCoach `main` was red on PostgreSQL from LA2 until H4** (`docs/history/handoffs/H4_HANDOFF.md`). This
...
* **The prompt**: for `tools.plan`, PromptCadence's `planner.draft` `1.1.0` prompt as G2 used it
  (`docs/history/handoffs/G2_HANDOFF.md` §4: 287-character system, 1 826-character user; the record is
...
1. `docs/history/handoffs/I2_HANDOFF.md` **§5** (the correction), **§10** (run 1 — the shape you are
   measuring), §13 item 3, §14 item 4.
2. `docs/adr/0098-…refusing-honestly.md` — rule 1 and the **Correction** section.
3. `docs/history/handoffs/G2_HANDOFF.md` **§4** (the measurement — six samples per setting, `format=json`,
   ...
   added then).
4. `docs/history/handoffs/H1_HANDOFF.md` **gate F** (what ModelRack built, and the byte-identical golden) and
...
2. **`docs/history/handoffs/I3_HANDOFF.md`**, house shape: gate results with invocations; each §0.2
