...
`packages/setspec/spec.md` (`setspec.prompts` record validation); `history/handoffs/W8_HANDOFF.md`.
...
Gate green, coverage held, one commit per gate, `docs/history/handoffs/W9_HANDOFF.md`, the row marked done.
