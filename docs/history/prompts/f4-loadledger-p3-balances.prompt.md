...
Nothing in F4 depends on F3's *content*. Read `docs/history/handoffs/F3_HANDOFF.md` only far enough to know which docs
...
7. **`docs/history/handoffs/F1_HANDOFF.md` §7** — the finding this row closes, in the words of the session that met it.
...
1. **`docs/history/handoffs/F4_HANDOFF.md` at the workspace root**, in the shape of `docs/history/handoffs/F1_HANDOFF.md`: what was built; the
