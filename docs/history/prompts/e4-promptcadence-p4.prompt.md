...
`docs/history/handoffs/D1_HANDOFF.md` §8/§13 and in `docs/history/handoffs/D2_HANDOFF.2.md` §4/§7. `xhigh` is what the schedule spends on rows
...
* **LoadCoach's local suite has exactly three pre-existing failures, and they are not yours:**
  ...
  `docs/history/handoffs/D2_HANDOFF.2.md` §7 and `docs/history/handoffs/E2_HANDOFF.md` §16 row G. **Confirm the count is exactly 3 before your
...
5. `docs/apps/loadcoach/routing.md` §§2–4 — the profile grammar and the hard constraints. A profile
   ...
   demonstration.
6. `docs/history/handoffs/D2_HANDOFF.2.md` §4 (the live journey and what it exposed), §5 (what the fake models now), §7
   (open items — the first is this row).
7. `docs/history/handoffs/D1_HANDOFF.md` §7, §8 and §13, and `docs/history/handoffs/E2_HANDOFF.md` §8 — **what this row must not relitigate.**
...
is the template (`docs/history/handoffs/D2_HANDOFF.2.md` §4); scratch data goes in the scratchpad only, and both servers
...
4. **`docs/history/handoffs/E4_HANDOFF.md` at the workspace root**, in the house shape: gate results with the interpreter;
...
* **Do not touch ToolYard.** `docs/history/handoffs/E2_HANDOFF.md` §8 lists what is settled: no rung below refusal, the
