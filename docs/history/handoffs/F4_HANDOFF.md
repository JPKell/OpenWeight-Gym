...
|---|---|---|
| Pre-flight (§0.1) | F3 finished, `docs` clean | `docs/history/handoffs/F3_HANDOFF.md` present; `docs` clean and ahead 4 (F3's `5946e3e`, `23e372c`, `9196580`, `986ab25`); LoadLedger at `c621ea2`, PromptCadence at `2bfc692`, both clean and level — all as §0 stated |
...
3. **"`balances()` … removes both workarounds"** (`docs/history/handoffs/F1_HANDOFF.md` §7, and the row text's "drop
