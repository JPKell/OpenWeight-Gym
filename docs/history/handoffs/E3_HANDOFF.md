...
`docs/history/handoffs/C3_HANDOFF.md` §2 and §11 settled the shapes to copy; this section is what remained to decide for
...
`docs/history/handoffs/C3_HANDOFF.md` §11 says to copy the whole of `tests/integration/`, `ledger_subprocess.py` included.
...
policy dimension. Nothing in `docs/history/handoffs/C3_HANDOFF.md` §2 or `docs/history/handoffs/B3_HANDOFF.md` §3 was relitigated — every place
