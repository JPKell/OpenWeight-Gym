...
* `setspec 0.5.0` — **initially appeared missing.** `pip index versions setspec` (and a fresh-venv
  install) returned only `0.4.0, 0.3.0, 0.2.0`, matching `docs/history/handoffs/B1_HANDOFF.md`'s own statement that B1
  ...
  The user replied "Its ready to go" and pointed at `docs/history/handoffs/B1_HANDOFF.md`'s tag/push snippet. Investigation
...
`request.requested_at` field *after* `docs/history/handoffs/B1_HANDOFF.md` was written (commit `72c5aab`, same day,
...
the kind of same-day drift worth knowing about if you're reading `docs/history/handoffs/B1_HANDOFF.md` verbatim rather
...
**Not touched, deliberately:** `docs/history/handoffs/B1_HANDOFF.md` (a dated record of what B1 actually did, under the
