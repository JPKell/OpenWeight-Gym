...
* **Everything in `docs/history/handoffs/D1_HANDOFF.md` §7 still stands**, and this row changed none of it: no rung below
...
1. **`pytest -m isolation -rs` on a podman host.** D1 kept podman **first** in the ladder and left it
   ...
   never executed its canary. `docs/history/handoffs/D1_HANDOFF.md` §13 row J makes this a precondition of this publish,
