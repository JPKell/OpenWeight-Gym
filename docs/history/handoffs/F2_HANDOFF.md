...
The fix was E5's sweep. `docs/history/handoffs/E5_HANDOFF.md` records that E5 ran on 2026-09-04 and stopped correctly
...
right that 0.2.2 was published and `docs/history/handoffs/E5_HANDOFF.md` §1's table was out of date, not the reverse.**

---

## 1. E5 resumed — the pin sweep, as built

Resumed at `docs/history/handoffs/E5_HANDOFF.md` §9: A4's install checks, then Gate B, then Gate C.
...
**The floor decision (`docs/history/handoffs/E5_HANDOFF.md` §9 vs the E5 row) was resolved by the operator in favour of
...
5. **The E5 row's `>=0.4,<0.7` for PromptCadence contradicted `docs/history/handoffs/E5_HANDOFF.md` §9's `>=0.5,<0.7`.**
...
2. **The E5 row and `docs/history/handoffs/E5_HANDOFF.md` §9 disagreed** about PromptCadence's floor (`>=0.4,<0.7` vs
...
scheduled **Sonnet 5 · standard** and ran on Opus 5; `docs/history/handoffs/E5_HANDOFF.md` already records that
