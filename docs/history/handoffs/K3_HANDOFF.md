...
`docs/history/handoffs/J2_HANDOFF.md` (all of it, §3 D3 and §8 especially), ADR-0104,
...
someone who evidently read `docs/history/handoffs/J2_HANDOFF.md` §8 carefully (the git-blame-precise
