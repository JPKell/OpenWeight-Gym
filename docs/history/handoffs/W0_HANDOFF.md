...
**Date:** 2026-09-09. **Kickoff:** [`w0-weightroom-phase-0.prompt.md`](../prompts/w0-weightroom-phase-0.prompt.md).
...
`history/prompts/*.prompt.md` before this row, and the paths line in `outstanding-work.md` (now says
