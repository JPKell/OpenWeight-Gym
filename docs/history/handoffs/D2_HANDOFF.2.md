...
attended. **Date:** 2026-09-03. **Supersedes nothing** — read `docs/history/handoffs/D2_HANDOFF.md` first; this file
...
| `domain/turns.py` | The absence cause now names the LoadCoach commit and `docs/history/handoffs/D2_HANDOFF.2.md`. Decision matrix and golden unchanged. |
...
2. **The shipped default tiers name profiles LoadCoach does not ship.** PromptCadence's defaults
   ...
   judgment call (`docs/history/handoffs/B4_HANDOFF.md` §3), now with evidence; **recorded, not chased** (§7).
