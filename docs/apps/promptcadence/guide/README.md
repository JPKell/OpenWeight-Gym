...
declaring `remote = true` and the tier is priced (ADR-0098). See [docs/](../../../README.md) for the
operator set and the [development plan](../development-plan.md) for what each
phase added.

Part of the **Local AI Suite**. Reaches a model only through [LoadCoach](https://github.com/JPKell/LoadCoach)'s
HTTP API — it never imports a model provider directly ([ADR-0045](../../../adr/0045-promptcadence-reaches-models-only-through-loadcoach.md)
...
[docs/apps/promptcadence/spec.md](../spec.md) §12 for the full configuration
...
Open <http://127.0.0.1:8768/> for the console. Read [docs/quickstart.md](quickstart.md) next.
...
response. See [docs/upgrading.md](upgrading.md) for the compatibility table.
...
| Read this | For |
|---|---|
| [docs/README.md](../../../README.md) | The operator set: quickstart, configuration reference, tiers, security, operations, troubleshooting, upgrading, the OpenAPI snapshot |
| [docs/apps/promptcadence/spec.md](../spec.md) | Purpose, scope, non-goals, public contracts, configuration, acceptance criteria |
| [docs/apps/promptcadence/lifecycle.md](../lifecycle.md) | The trajectory state machine, deviation categories and estimator |
| [docs/apps/promptcadence/development-plan.md](../development-plan.md) | The phased build plan: goals, work, tests, acceptance criteria per phase |
